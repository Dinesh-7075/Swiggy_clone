...
const NavBar = () => {
  ...
  return (
    <div className="navbar flex justify-between flex-row mb-6 w-[100%]">
      <div className="logo">
      <Link to="/" >
        <img src={LOGO_URL} className="mx-10" />
      </Link>
      </div>
      <div className="nav-items flex items-center">
        <ul className="flex items-center mr-6">
          <li className="px-6 pr-[0.5rem]">
            <Link to="/" className="nav-links flex">
              <svg
                className="mr-2 mt-1"
                viewBox="0 0 32 32"
                height="19"
          ...
          <li className="px-6 pr-[0.5rem]" >
            <Link to="/profile" className="nav-links flex">
              <svg
                className="mr-2 mt-1"
                viewBox="6 0 12 24"
                height="19"
          ...
          <li className="px-6 pr-[0.5rem]">
            <Link to="/cart" className="nav-links flex">
              <svg
                className="mr-2 mt-1"
                viewBox="-1 0 37 32"
                height="20"
          ...
          <li className="px-6  pr-[0.5rem]">
            <button
              className="login-btn  bg-green-100 px-2 rounded-md hover:bg-green-200"
              onClick={() => {
                loginBtn === "Login"
                  ? setLoginBtn("Logout")
                  : setLoginBtn("Login");
